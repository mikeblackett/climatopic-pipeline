...
for asset in assets:
    checks.extend(
        [
            # TODO: Currently Dagster does not support assets checks per-partition.
            # See https://github.com/dagster-io/dagster/issues/17005
            # build_xarray_frequency_check(asset.key, freq='D'),
            build_xarray_cf_attributes_check(
                asset.key, attrs=['cell_methods', 'standard_name']
            ),
